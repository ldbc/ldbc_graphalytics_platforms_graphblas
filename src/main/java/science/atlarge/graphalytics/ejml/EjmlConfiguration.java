 ...
 * @author Bálint Hegyi
 */
public final class EjmlConfiguration {

	protected static final Logger LOG = LogManager.getLogger();

	private static final String BENCHMARK_PROPERTIES_FILE = "benchmark.properties";
	private static final String HOME_PATH_KEY = "platform.ejml.home";
	private static final String NUM_MACHINES_KEY = "platform.ejml.num-machines";
	private static final String NUM_THREADS_KEY = "platform.ejml.num-threads";
	...
	/**
	 * Creates a new EjmlConfiguration object to capture all platform parameters that are not specific to any algorithm.
	 */
	public EjmlConfiguration(){
	}
	...
	public static EjmlConfiguration parsePropertiesFile() {

		EjmlConfiguration platformConfig = new EjmlConfiguration();
