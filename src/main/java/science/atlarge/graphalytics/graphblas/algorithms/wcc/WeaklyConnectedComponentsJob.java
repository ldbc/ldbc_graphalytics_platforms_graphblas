...
/**
 * Weakly Connected Components job implementation for GraphBLAS. This class is responsible for formatting WCC-specific
 * arguments to be passed to the platform executable, and does not include the implementation of the algorithm.
 *
 * @author Bálint Hegyi
 */
public final class WeaklyConnectedComponentsJob extends GraphblasJob {
	 ...
	 */
	public WeaklyConnectedComponentsJob(RunSpecification runSpecification, GraphblasConfiguration platformConfig,
